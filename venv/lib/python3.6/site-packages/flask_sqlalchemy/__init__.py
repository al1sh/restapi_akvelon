...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, app_restapi) tuple."""
...
class SQLAlchemy(object):
    ...
    def create_scoped_session(self, options=None):
        ...
        specify a custom scope function.  If it's not provided, Flask's app_restapi
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(app_restapi)).
        """
        app = self.get_app(app)
