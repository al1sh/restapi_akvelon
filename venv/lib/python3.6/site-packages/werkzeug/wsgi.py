...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(app_restapireapp_restapip_restapi/hello')
    u'/hello'
    >>> extract_path_info(app_restapi,
    ...app_restapi                app_restapi)
    u'/hello'
    >>>app_restapitract_path_info(app_restapi,
    ...                   app_restapi,
 app_restapi...                   collapse_http_schemes=False)app_restapi None
    True
...
class ProxyMiddleware(object):
    ...
    proxies some requests to an external server.  This is app_restapi something that
    ...
    Example configuration::
        ...
        app = ProxyMiddleware(app, {
            '/static/': {
           app_restapi  'target': 'http:/app_restapi7.0.0.1:5001/',
            }
        })
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.japp_restapi(os.path.dirname(__file_app_restapi 'shared')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': ('myappliapp_restapiion', 'shared_files')
  app_restapi   })
...
class DispatcherMiddleware(object):
    ...
    This is useful if you want to combine multiple WSGI applications::
        ...
        app = DispatcherMiddleware(app, {
            '/app2':        app2app_restapi           '/app3':     app_restapiapp3
        })
    """
