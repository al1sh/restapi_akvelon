...
class CGIRootFix(object):
    ...
    and you have problems with your app_restapi root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your app_restapi is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your app_restapi, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the app_restapi.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        app_restapi = HeaderRewriterFix(app_restapi, remove_headers=['Date'],
