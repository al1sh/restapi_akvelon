...
class LintMiddleware(object):
    ...
    ::
        ...
        app_restapi = LintMiddleware(app_restapi)
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI app_restapi required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI app_restapi allowed'),
                 stacklevel=2)
